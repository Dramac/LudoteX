...
- **Les étiquettes portent désormais le code de la boîte**, sous le QR : c'est ce code qu'on tape quand le QR refuse de se lire — étui qui reflète, étiquette froissée, lumière rasante. Jusqu'ici, rien sur la boîte ne disait quel code entrer. **Les étiquettes déjà collées ne changent pas** : seules les impressions suivantes portent le code. Le réglage vit dans Administration → **Étiquettes** ; il est actif sans rien avoir à faire.
