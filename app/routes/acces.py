...
l'appareil mémorise le jeton (cookie) et peut ensuite accéder à /pret et
/scanner. Rotation annuelle = changer `PRET_TOKEN` (les anciens cookies cessent
d'être valides).
"""
...
def acces(request: Request, jeton: str = ""):
    ...
    if attendu and secrets.compare_digest(jeton, attendu):
        ...
        reponse.set_cookie(
            ...
            max_age=UN_AN, httponly=True, samesite="lax",
